...
{
    public partial class FaseUm : Form
    {

        int[] x = { 211, 366, 530, 692 };
        int[] y = { 73, 202, 328, 457 };
        ...
        private void FinalJogo()
        {
            ...
            {
                DialogResult resultado = MessageBox.Show("Parabens você passou de fase... Deseja Continuar?", "Passou de fase", MessageBoxButtons.YesNo);
